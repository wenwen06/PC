<template>
	<div>
		<div class="text-top">
			<el-button type="primary" id="xz" icon="el-icon-circle-plus-outline" @click="show">请休假申请</el-button>
		</div>
		<div id="table">
			...
			<div id="mask" v-show="is_show">
				<div class="mask">
					...
					<div class="content">
						...
						<el-input v-model="newsList.name" placeholder="申请人"></el-input>
						<el-input v-model="newsList.address" placeholder="所属部门"></el-input>
						<el-input v-model="newsList.leix" placeholder="类型"></el-input>
						<el-input v-model="newsList.cong" placeholder="时间段"></el-input>
						<el-input v-model="newsList.zwu" placeholder="共计时长"></el-input>
	...
	export default {
		data() {
			return {
				is_show: false,
				newsList: [{
						date: '请休假申请-李萌-1000450',
						name: '李萌',
						address: '销售部',
						leix:'请假',
						cong: '2016/4/16 8:00 ~ 2016/4/16 18:00',
						zwu: '1天 0小时'
					},
					{
						date: '请休假申请-李萌-10004502',
						name: '李萌',
						address: '销售部',
						leix:'请假',
						cong: '2016/4/16 8:00 ~ 2016/4/16 18:00',
