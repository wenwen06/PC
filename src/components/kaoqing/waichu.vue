<template>
	<div>
		<div class="text-top">
			<el-button type="primary" id="xz" icon="el-icon-circle-plus-outline" @click="show">外出申请</el-button>
		</div>
		<div id="table">
			...
			<div id="mask" v-show="is_show">
				<div class="mask">
					...
					<div class="content">
						...
						<el-input v-model="newsList.cong" placeholder="目的地"></el-input>
	...
	export default {
		data() {
			return {
				is_show: false,
				newsList: [{
						date: '外出申请-季道晓-1000539',
						name: '季道晓',
						address: '销售部',
						cong: '广州天河万科地产',
						zwu: '2016/4/14 8:00 ~ 2016/4/14 12:00'
					},
					{
						date: '外出申请-季道晓-10005392',
						name: '季道晓',
						address: '销售部',
						cong: '广州天河万科地产',
						zwu: '2016/4/14 8:00 ~ 2016/4/14 12:00'
