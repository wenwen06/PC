<template>
	<div>
		<div class="text-top">
			<el-button type="primary" id="xz" icon="el-icon-circle-plus-outline" @click="show">员工培训安排</el-button>
		</div>
		<div id="table">
			...
			<div id="mask" v-show="is_show">
				<div class="mask">
					...
					<div class="content">
						...
						<el-input v-model="newsList.name" placeholder="培训类型"></el-input>
						<el-input v-model="newsList.address" placeholder="受培训人员"></el-input>
		...
		data() {
			return {
				...
				newsList: [{
					...
					{
						date: '员工培训安排-李萌-10009602',
						name: '技术培训,',
						address: '李萌,沈华,沈涛辉,张旭,张瑶瑶,季道晓,',
						zwu: '2016/4/1 ~ 2019/4/1'
					},
					{
						date: '员工培训安排-李萌-10009603',
						name: '技术培训3',
						address: '李萌,沈华,沈涛辉,张旭,张瑶瑶,季道晓,',
						zwu: '2016/4/1 ~ 2019/4/1'
					},
					{
						date: '员工培训安排-李萌-10009604',
						name: '技术培训345',
						address: '李萌,沈华,沈涛辉,张旭,张瑶瑶,季道晓,',
						zwu: '2016/4/1 ~ 2019/4/1'
					}
