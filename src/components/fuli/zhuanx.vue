<template>
	<div>
		<div class="text-top">
			<el-button type="primary" id="xz" icon="el-icon-circle-plus-outline" @click="show">员工福利申请</el-button>
		</div>
		<div id="table">
			...
			<div id="mask" v-show="is_show">
				<div class="mask">
					...
					<div class="content">
						...
						<el-input v-model="newsList.fuli" placeholder="专项福利"></el-input>
