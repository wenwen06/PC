<template>
	<div>
		<div class="text-top">
			<el-button type="primary" id="xz" icon="el-icon-circle-plus-outline" @click="show">离职申请</el-button>
		</div>
		<div id="table">
			...
			<div id="mask" v-show="is_show">
				<div class="mask">
					...
					<div class="content">
						...
						<input type="text" v-model="newsList.cong" name="date" value="" placeholder="工作岗位" />
						<input type="text" v-model="newsList.zwu" name="date" value="" placeholder="申请时间" />
						<input type="text" v-model="newsList.ruzhi" name="date" value="" placeholder="预计离职日期" />
