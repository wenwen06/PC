<template>
	<div>
		<div class="text-top">
			<el-button type="primary" id="xz" icon="el-icon-circle-plus-outline" @click="show">招聘申请</el-button>
		</div>
		<div id="table">
			...
			<div id="mask" v-show="is_show">
				<div class="mask">
					...
					<div class="content">
						...
						<el-input v-model="newsList.cong" placeholder="需求岗位"></el-input>
						<el-input v-model="newsList.zwu" placeholder="需求人数"></el-input>
						<el-input v-model="newsList.ruzhi" placeholder="希望到岗日期"></el-input>
